---
title: "Which Cloud Software Stocks Actually Benefit from AI? I Analyzed 30 Companies to Find Out"
description: "Independent analysis of 30 cloud software companies from the BVP Emerging Cloud Index, scoring how AI impacts customer demand for each one."
pillar: "invest"
format: "Deep Dive"
...
Four companies illustrate why the infrastructure layer wins.
...
These three companies benefit from AI, but each carries a specific competitive risk that could cap the upside.
...
After analyzing 30 companies, some patterns are hard to ignore.
...
**Microsoft is the universal bear case.** In 25 of 30 analyses, Microsoft appeared as a competitive threat. E5 licensing bundles security, analytics, CRM, HR tools, and AI copilots at zero marginal cost. Any SaaS company in a Microsoft-adjacent category faces this gravity.
...
For reference, all 31 companies ranked by estimated AI demand impact:
...
| 5 | Palantir | PLTR | Data Analytics |
| 6 | Shopify | SHOP | E-Commerce |
| 7 | Veeva | VEEV | Life Sciences |
| 8 | Okta | OKTA | Identity |
| 9 | ServiceNow | NOW | ITSM |
| 10 | Zeta Global | ZETA | Marketing Intelligence |
| 11 | Cloudflare | NET | Edge/CDN |
| 12 | Workday | WDAY | HCM/Finance |
| 13 | Toast | TOST | Restaurant Tech |
| 14 | MongoDB | MDB | Database |
| 15 | Adobe | ADBE | Creative |
| 16 | Zscaler | ZS | Cybersecurity |
| 17 | Confluent | CFLT | Data Streaming |
| 18 | Snowflake | SNOW | Data Warehouse |
| 19 | Salesforce | CRM | CRM |
| 20 | Atlassian | TEAM | Dev Tools |
| 21 | SentinelOne | S | Cybersecurity |
| 22 | Elastic | ESTC | Search/Analytics |
| 23 | GitLab | GTLB | DevOps |
| 24 | DocuSign | DOCU | E-Signature |
| 25 | RingCentral | RNG | UCaaS |
| 26 | Five9 | FIVN | Contact Center |
| 27 | UiPath | PATH | RPA |
| 28 | monday.com | MNDY | Work Management |
| 29 | Sprinklr | CXM | CX Management |
| 30 | Asana | ASAN | Work Management |
| 31 | HubSpot | HUBS | CRM |
